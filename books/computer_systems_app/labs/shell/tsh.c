...
/*
 * debug - log debugging messages when enabled
*/
void debug(const char *msg) {
    if (DEBUG) {
...
int builtin_cmd(char **argv)
{
    ...
    {
        debug("got 'bg' command\n");
        return 1;
    } else if (strcasecmp(argv[0], "fg") == 0)
    {
        debug("got 'fg' command");
        return 1;
    ...
    else if (strcasecmp(argv[0], "quit") == 0)
    {
        ...
        // NB: background procs do not get interrupted or killed.
        exit(0);
    } 
