...
#    python_config.run_command = "import lox.main; lox.main.main()"

    # Run a Python module as __main__ when the interpreter starts.
    python_config.run_module = "lox.main"
    # Run a Python file when the interpreter starts.
#    python_config.run_filename = "/lox/main.py"
    ...
    # Python packages.
    exe.add_python_resources(exe.read_package_root(CWD, packages=["lox"]))
